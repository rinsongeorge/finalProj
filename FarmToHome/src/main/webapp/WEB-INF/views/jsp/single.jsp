	  ...
	  <div class="content_box">
		<div class="container">
				...
				<div class="col-md-3">
					<div class="menu_box">
				   	     ...
				   	     <ul class="nav">
					   	  	...
					   	  	<li><a href="javascript:void(0)">Surf Apparel</a></li>
					   	  	<li><a href="javascript:void(0)">Windsurf</a></li>
					   	  	<li><a href="javascript:void(0)">Kitesurf</a></li>
				     ...
				     <ul id="etalage">
							<li>
								<a href="javascript:void(0)">
									<img class="etalage_thumb_image" src="resources/static/images/pic6.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="resources/static/images/pic6.jpg" class="img-responsive" />
								</a>
							</li>
							<!-- <li>
								<img class="etalage_thumb_image" src="resources/static/images/pic6.jpg" class="img-responsive" />
		   ...
		   <div class="sap_tabs">	
				     ...
				     <ul id="flexiselDemo3">
						<li><img src="resources/static/images/pic6.jpg" /><div class="grid-flex"><a href="#">Syenergy 2mm</a><p>Rs 850</p></div></li>
						<li><img src="resources/static/images/pic6.jpg" /><div class="grid-flex"><a href="#">Surf Yoke</a><p>Rs 1050</p></div></li>
						<li><img src="resources/static/images/pic6.jpg" /><div class="grid-flex"><a href="#">Salty Daiz</a><p>Rs 990</p></div></li>
						<li><img src="resources/static/images/pic6.jpg" /><div class="grid-flex"><a href="#">Cheeky Zane</a><p>Rs 850</p></div></li>
						<li><img src="resources/static/images/pic6.jpg" /><div class="grid-flex"><a href="#">Synergy</a><p>Rs 870</p></div></li>
				     </ul>
				    <script type="text/javascript">
